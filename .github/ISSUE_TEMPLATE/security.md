---
name: Security issue (DO NOT USE THIS TEMPLATE FOR ACTUAL VULNERABILITIES)
about: Placeholder so the security workflow is discoverable from the issue picker
title: '[SECURITY] '
labels: security
---
...
<!-- Describe the non-vulnerability security topic. -->

## Context

<!-- Where in the docs / code did this come up? -->
